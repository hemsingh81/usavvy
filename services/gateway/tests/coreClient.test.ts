...
describe("createCoreClient().forwardBinary", () => {
  ...
  it("returns a Buffer and the response's content-type on a successful binary response", async () => {
  ...
  it("falls back to parsing a JSON error envelope on a non-2xx response", async () => {
