...
import type { Availability, BoardTheme, ColorTheme, ExplanationStyle, LearnerLevel } from "@usavvy/shared-types";
...
export const learnerProfiles = pgTable("learner_profiles", {
  ...
  // Story 1.9 (FR-A-9): same nullable-not-defaulted-at-the-DB-level convention as the
  // other preference columns above — default is DEFAULT_LEARNER_PREFERENCES.colorTheme.
