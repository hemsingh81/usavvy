...
import { Switch } from "../../shared/index.js";
...
export function PreferencesPage() {
  ...
  // "applied instantly... no page reload"). Optimistic update, reverted on failure —
  // a failed save must not disturb the other five controls' current values.
  ...
  return (
    <main>
      ...
      {/* No single submit — every control auto-saves independently — but Radix's
          Form.Field (used below for the enum selects and the speechRate input) still
      ...
      <Form.Field name="speechRate" className="usavvy-field">
        <Form.Label className="usavvy-label">Speech rate</Form.Label>
